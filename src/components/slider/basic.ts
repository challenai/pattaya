...
export function shapes(
    { totalLength, progress, slideWidth, barWidth, radius }: SliderProps,
    styles: SliderStyles,
): Shapes {
...
export function wireframeBar(
    slideLength: number,
    barWidth: number,
    totalLength: number,
): string {
    return rectangle.basicAligned(
        slideLength,
        -barWidth / 2,
        totalLength,
        barWidth,
