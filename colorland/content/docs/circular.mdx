...
import { sector, pie } from "./circular";
...
<Graph layers={sector} options={[]} height={400} styles={{ marginBottom: "32px" }} />
...
<Graph layers={pie} options={[]} height={400} styles={{ marginBottom: "32px" }} />
